...
from ... import BertJapaneseTokenizer
...
class LukeJapaneseTokenizer(BertJapaneseTokenizer):
    r"""
    Construct a LUKE tokenizer.

    This tokenizer inherits from :class:`~transformers.BertJapaneseTokenizer` which contains most of the main methods. Users
    should refer to this superclass for more information regarding those methods. Compared to
    :class:`~transformers.BertJapaneseTokenizer`, :class:`~transformers.LukeJapaneseTokenizer` also creates entity sequences, namely
    ...
    def save_vocabulary(self, save_directory: str, filename_prefix: Optional[str] = None) -> Tuple[str]:
        vocab_file  = super().save_vocabulary(save_directory, filename_prefix)
